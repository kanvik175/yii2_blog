            ...
            <div class="col-md-8">
                ...
                <article class="post">
                    <div class="post-thumb">
                        <a href="blog.html"><?= Html::img("@web{$article->getImage()}", ['alt' => 'Наш логотип']) ?></a>
                ...
                <div class="primary-sidebar">
                    ...
                    <aside class="widget">
                        ...
                        <div class="popular-post">
                            ...
                            <a href="#" class="popular-img"><?= Html::img("@web{$article->getImage()}", ['alt' => 'Картинка']) ?>
                        ...
                        <div class="thumb-latest-posts">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#" class="popular-img"><?= Html::img("@web{$article->getImage()}", ['alt' => 'Test']) ?>
                                        <div class="p-overlay"></div>
                                    </a>
                                </div>
                                <div class="p-content">
